Name "citrinoc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/citrino-network/citrino-cli/issues"
!define UPDATEURL "https://github.com/citrino-network/citrino-cli/releases"
!define ABOUTURL "https://github.com/citrino-network/citrino-cli#ethereum-go"
...
# Install citrinoc binary
Section "Citrinoc" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Citrinoc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\citrinoc.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\citrinoc.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Citrinoc incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Citrinoc outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Citrinoc UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Citrinoc incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\citrinoc.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Citrinoc outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\citrinoc.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Citrinoc UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\citrinoc.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\citrinoc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\citrinoc.ipc"
