...
import (
	...
	"github.com/citrino-network/citrino-cli/internal/jsre/deps"
	"github.com/citrino-network/citrino-cli/internal/web3ext"
...
// Welcome show summary of current Citrinoc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Citrinoc JavaScript console!\n\n"

	// Print some generic Citrinoc metadata
