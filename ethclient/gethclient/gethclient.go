...
// Package citrinocclient provides an RPC client for citrinoc-specific APIs.
...
// Client is a wrapper around rpc.Client that implements citrinoc-specific functionality.
//
...
// GCStats retrieves the current garbage collection stats from a citrinoc node.
...
// MemStats retrieves the current memory stats from a citrinoc node.
...
// GetNodeInfo retrieves the node info of a citrinoc node.
