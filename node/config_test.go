...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "citrinoc.ipc", false, filepath.Join(os.TempDir(), "citrinoc.ipc")},
		{"data", "citrinoc.ipc", false, "data/citrinoc.ipc"},
		{"data", "./citrinoc.ipc", false, "./citrinoc.ipc"},
		{"data", "/citrinoc.ipc", false, "/citrinoc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "citrinoc.ipc", true, `\\.\pipe\citrinoc.ipc`},
		{"data", "citrinoc.ipc", true, `\\.\pipe\citrinoc.ipc`},
		{"data", `\\.\pipe\citrinoc.ipc`, true, `\\.\pipe\citrinoc.ipc`},
	}
