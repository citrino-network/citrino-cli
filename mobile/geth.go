...
// NodeConfig represents the collection of configuration values to fine tune the Citrinoc
...
// Node represents a Citrinoc Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Citrinoc node.
