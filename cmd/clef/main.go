...
import (
	...
	"github.com/citrino-network/citrino-cli/signer/core"
	"github.com/citrino-network/citrino-cli/signer/core/apitypes"
	"github.com/citrino-network/citrino-cli/signer/fourbyte"
	"github.com/citrino-network/citrino-cli/signer/rules"
	"github.com/citrino-network/citrino-cli/signer/storage"
...
var (
	...
	chainIdFlag = cli.Int64Flag{
		...
		Usage: "Chain id to use for signing (57=mainnet, 3=Ropsten)",
	}
	rpcPortFlag = cli.IntFlag{
		Name:  "http.port",
		Usage: "HTTP-RPC server listening port",
		Value: node.DefaultHTTPPort + 57,
	}
...
func checkFile(filename string) error {
	...
	// https://github.com/citrino-network/citrino-cli/issues/20123
