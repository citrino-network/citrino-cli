...
import (
	...
	"github.com/citrino-network/citrino-cli/accounts/external"
	"github.com/citrino-network/citrino-cli/accounts/keystore"
	"github.com/citrino-network/citrino-cli/accounts/scwallet"
	"github.com/citrino-network/citrino-cli/accounts/usbwallet"
	"github.com/citrino-network/citrino-cli/cmd/utils"
	"github.com/citrino-network/citrino-cli/eth/catalyst"
...
func loadConfig(file string, cfg *citrinocConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "citrinoc.ipc"
	return cfg
}

// makeConfigNode loads citrinoc configuration and creates a blank node instance.
func makeConfigNode(ctx *cli.Context) (*node.Node, citrinocConfig) {
	// Load defaults.
	cfg := citrinocConfig{
...
// makeFullNode loads citrinoc configuration and creates the Ethereum backend.
...
func applyMetricConfig(ctx *cli.Context, cfg *citrinocConfig) {
