...
import (
	...
	"github.com/citrino-network/citrino-cli/accounts"
	"github.com/citrino-network/citrino-cli/accounts/keystore"
	"github.com/citrino-network/citrino-cli/common"
	"github.com/citrino-network/citrino-cli/common/fdlimit"
	"github.com/citrino-network/citrino-cli/consensus"
	"github.com/citrino-network/citrino-cli/consensus/clique"
	"github.com/citrino-network/citrino-cli/consensus/ethash"
	"github.com/citrino-network/citrino-cli/core"
	"github.com/citrino-network/citrino-cli/core/rawdb"
	"github.com/citrino-network/citrino-cli/core/vm"
	"github.com/citrino-network/citrino-cli/crypto"
	"github.com/citrino-network/citrino-cli/eth"
	"github.com/citrino-network/citrino-cli/eth/downloader"
	"github.com/citrino-network/citrino-cli/eth/ethconfig"
	"github.com/citrino-network/citrino-cli/eth/gasprice"
	"github.com/citrino-network/citrino-cli/eth/tracers"
	"github.com/citrino-network/citrino-cli/ethdb"
	"github.com/citrino-network/citrino-cli/ethstats"
	"github.com/citrino-network/citrino-cli/graphql"
	"github.com/citrino-network/citrino-cli/internal/ethapi"
	"github.com/citrino-network/citrino-cli/internal/flags"
	"github.com/citrino-network/citrino-cli/les"
	"github.com/citrino-network/citrino-cli/log"
	"github.com/citrino-network/citrino-cli/metrics"
	"github.com/citrino-network/citrino-cli/metrics/exp"
	"github.com/citrino-network/citrino-cli/metrics/influxdb"
	"github.com/citrino-network/citrino-cli/miner"
	"github.com/citrino-network/citrino-cli/node"
	"github.com/citrino-network/citrino-cli/p2p"
	"github.com/citrino-network/citrino-cli/p2p/enode"
	"github.com/citrino-network/citrino-cli/p2p/nat"
	"github.com/citrino-network/citrino-cli/p2p/netutil"
...
func MakeDataDir(ctx *cli.Context) string {
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
		if ctx.GlobalBool(RopstenFlag.Name) {
			// Maintain compatibility with older Citrinoc configurations storing the
...
// for Citrinoc and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `citrinoc account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "citrinoc.", tagsMap)
		} else if enableExportV2 {
			tagsMap := SplitTagsFlag(ctx.GlobalString(MetricsInfluxDBTagsFlag.Name))

			log.Info("Enabling metrics export to InfluxDB (v2)")

			go influxdb.InfluxDBV2WithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, token, bucket, organization, "citrinoc.", tagsMap)
		}
...
// new format.
//
// e.g. citrinoc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// citrinoc --keystore /tmp/mykeystore --lightkdf account new
//
