...
// It can be used for testing that restart Citrinoc normally.
...
// It can be used for testing that restart Citrinoc after the crash.
...
// Tests a Citrinoc restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Citrinoc was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Citrinoc was crashed and restarts with a broken snapshot. In this case
...
// Tests a Citrinoc was running with snapshot enabled. Then restarts without
...
// Tests the Citrinoc was running with snapshot enabled and resetHead is applied.
...
// Tests the Citrinoc was running with a complete snapshot and then imports a few
