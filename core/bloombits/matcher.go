...
// that address/topic, and binary AND-ing those vectors tocitrinocer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them tocitrinocer
				var orVector []byte
...
// the requested retrieval queue to be serviced tocitrinocer with other sessions.
//
