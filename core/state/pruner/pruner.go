...
pruning. Remember don't start the Citrinoc without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "citrinoc snapshot prune-state --help" for more details.
`
